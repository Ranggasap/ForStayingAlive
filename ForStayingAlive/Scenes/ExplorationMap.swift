...
class ExplorationMap: SKScene {
	...
	func addJoystick() {
		...
		joystick.trackingHandler = { [unowned self] data in
			...
			let moveSpeed: CGFloat = self.runningButton.isPressed ? 0.4 : 0.2 // Adjust speed based on running button state
